...
public class Aramark_CIP3{

	static GetPageObject PO = new GetPageObject();

	//Aramark Login Page 
	public static void Aramark_Login(){
		PO.add("url::http://fusion.ihsmarkit.com");
		PO.add("LanguageMenu::id=languageMenu");
	...
	public static void Aramark_Plan(){
		PO.add("PlanListingCrumb::xpath=//li[contains(text(),\"Plan Listing\")]");
		PO.add("CreatePlan_Btn::xpath=//button[@ng-click=\"pageNavigateToCreate()\"]");
