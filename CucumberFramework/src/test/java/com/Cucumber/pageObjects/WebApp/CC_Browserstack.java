...
//	 CC_AddProductThroughCat
		public static void CC_AddProductThroughCat(){
			...
			PO.add("Audio_Cat::xpath=//li[4]/.//a[@class='menuLink']");
			PO.add("Product_image::xpath=//div[@class='product_listing_container']//li[1]/.//div[@class='product_image']");
			PO.add("Product_name::xpath=//div[@class='product_listing_container']//li[1]/.//div[@class='product_name']");
...
//   CC_AddProductThroughSearch 
		public static void CC_AddProductThroughSearch(){
			...
			PO.add("SearchIcn::xpath=//a[@class='submitButton']");
		}
...
//   CC_Checkout 
		public static void CC_Checkout(){
			...
			PO.add("Continue_btn::id=shippingButton");
			PO.add("PaymentContinue_btn::id=submit");
...
//   CC_Guest_Checkout
		public static void CC_Guest_Checkout(){
			...
			PO.add("Zipcode::id=WC_ShippingAddressForm_AddressEntryForm_FormInput_zipCode_1");
			PO.add("Iframe_CreditCard::id=braintree-hosted-field-number");
			PO.add("CreditCard::id=credit-card-number");
			PO.add("Iframe_Cvv::id=braintree-hosted-field-cvv");
			PO.add("Cvv::id=cvv");
			PO.add("Iframe_Month::id=braintree-hosted-field-expirationMonth");
			PO.add("Month::name=expiration-month");
			PO.add("MonthValue::value=10");
			PO.add("MonthName::linkText=10 - October");
			PO.add("Iframe_Year::id=braintree-hosted-field-expirationYear");
			PO.add("Year::name=expiration-year");
...
//   Not Using
		public static void CC_NotUsing(){
			PO.add("First_Name_Field::id=WC__NameEntryForm_FormInput_firstName_1");
...
//			PO.add("Cams_cat::id=departmentLink_25503_alt");	
			...
			PO.add("Product1::linkText=Case Logic TBC411INDIGO DSLR COMPACT BACKPACK DOBBY");
			PO.add("Add2Cart::id=add2CartBtn");
//			PO.add("CartClose::id=MiniShopCartCloseButton_2");
			...
			PO.add("Orignal_Address::xpath=//label[contains(text(),'Use Original Address')]");
		}	
