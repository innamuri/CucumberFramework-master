...
And I login to aramark as 'regional_manager'
And I click 'UserMenu'
And I wait for '2' seconds
Then I should see text 'RM RM' present on page at 'userTxtlocation'
...
When I click 'Plan_Btn'
And I wait '25' seconds for presence of element 'CreatePlan_Btn'
Then I should see element 'Home_link' present on page
